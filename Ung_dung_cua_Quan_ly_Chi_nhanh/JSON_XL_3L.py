...
Thu_muc_Quan_ly_Chi_nhanh = Thu_muc_Du_lieu/"Quan_ly_Chi_nhanh"
...
def Doc_Danh_sach_Quan_ly_Don_vi():
    Danh_sach = []
    for Duong_dan in Thu_muc_Quan_ly_Don_vi.glob("*.json"):
        Chuoi_JSON = Duong_dan.read_text("utf-8")
...
def Doc_Danh_sach_Quan_ly_Chi_nhanh():
    Danh_sach = []
    for Duong_dan in Thu_muc_Quan_ly_Chi_nhanh.glob("*.json"):
        Chuoi_JSON = Duong_dan.read_text("utf-8")
        Nhan_vien = json.loads(Chuoi_JSON)
        Danh_sach.append(Nhan_vien)
    return Danh_sach
